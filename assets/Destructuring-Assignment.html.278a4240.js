import{_ as e,o as n,c as i,a as s}from"./app.721c7a1a.js";const a={},d=s(`<h1 id="对象解构" tabindex="-1"><a class="header-anchor" href="#对象解构" aria-hidden="true">#</a> 对象解构</h1><p>如何将 js 对象的各个属性值赋值给另外单独的变量？</p><h2 id="不推荐方式" tabindex="-1"><a class="header-anchor" href="#不推荐方式" aria-hidden="true">#</a> 不推荐方式</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>const user = {
    name: &#39;zhangsan&#39;,
    age: 10,
    gender: &#39;male&#39;
};
